...
import com.cargo.booking.account.dto.participant.DetailedParticipantDto;
...
public abstract class ParticipantMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "workspacesNames", ignore = true)
    })
    public abstract DetailedParticipantDto participantToDetailedParticipantDto(Participant participant);
}
